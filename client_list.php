          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Clientes <small>Lista de clientes activos en el sistema</small></h3>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><small>Información básica del Cliente</small></h2> 
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                          ...
                          <div class="col-xs-12 bottom text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 emphasis">
                              <button type="button" class="btn btn-success btn-xs"> <i class="fa fa-user">
                                </i> <i class="fa fa-comments-o"></i> Editar Perfil</button>
